  ...
  useEffect(() => {
    if (password && activeTab === "signup") {
      ...
      if (passwordErrors.length > 0) {
        setPasswordStrengthError(passwordErrors.join(", "));
      } else {
          ...
          <StyledForm onSubmit={handleSignupSubmit}>
            ...
            <InputGroup>
              ...
              {passwordStrengthError && (
                <PasswordStrengthMessage>{passwordStrengthError}</PasswordStrengthMessage>
              )}
            ...
            <SubmitButton type="submit" disabled={!!passwordStrengthError}>SignUp</SubmitButton>
          </StyledForm>
        )}
      </Content>
    </Container>
...
// The existing styled components would be here
// Adding a new styled component for password strength messages:
