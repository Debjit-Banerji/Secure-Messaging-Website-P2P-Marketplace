...
import { MdGroupAdd, MdSettings, MdMoreVert } from "react-icons/md";
import DefaultProfilePic from "../assets/profileicon.png";
import DefaultGroupPic from "../assets/DefaultGroupPic.jpeg";
import { useDispatch, useSelector } from "react-redux";
import { getUserData, removeContacts } from "../store/slices/user-slice";
...
export default function Contacts({ contacts, groups, changeChat }) {
  ...
  // Handle the menu toggle separately
  const handleMenuToggle = (e, contactId) => {
    e.stopPropagation(); // Stop propagation to prevent changeCurrentChat
                ...
                {menuOpen === contact.id && (
                  <div className="dropdown-menu">
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
                        dispatch(removeContacts({...contact}));
                        setMenuOpen(null);
                      }}
                    >
                      Report and Block
